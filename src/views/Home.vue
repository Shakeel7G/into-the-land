...
<style scoped>
/* Base – light */
:root { --container: 1140px; --gap: 1.25rem; }
...
/* HERO */
.hero { position: relative; height: 100vh; min-height: 640px; overflow: hidden; border-radius: 10px; }
...
.hero-center h1 { font-size: clamp(2.4rem, 6vw, 4.2rem); line-height:1.05; margin-bottom:.6rem; }
.hero-center p { font-size: clamp(1.05rem, 2.4vw, 1.35rem); margin-bottom: 1.3rem; opacity:.98; }
.hero-ctas { display:flex; gap:.8rem; justify-content:center; flex-wrap:wrap; }

/* Buttons */
.btn { display:inline-block; border:1px solid transparent; padding:.85rem 1.25rem; border-radius:10px; font-weight:800; text-decoration:none; }
...
.btn-sm { padding:.55rem .9rem; border-radius:9px; background:#16a34a; color:#fff; }
.btn-sm:hover { background:#15803d; }

/* Scroll cue */
.scroll-cue { position:absolute; left:50%; bottom:22px; transform:translateX(-50%); width:28px; height:44px; border:2px solid #ffffff66; border-radius:20px; display:grid; place-items:center; }
.chevron {
  width: 8px; height: 8px; border-right: 2px solid #fff; border-bottom: 2px solid #fff; transform: rotate(45deg); margin-top:6px;
...
.link { color:#16a34a; text-decoration:none; font-weight:800; }
.link:hover { text-decoration: underline; }

/* Features – light cards */
.features { display:grid; grid-template-columns: repeat(12, 1fr); gap: var(--gap); }
.feature {
  grid-column: span 12; background:#fff; border-radius:14px; padding:1.25rem; text-align:center;
  box-shadow:0 4px 14px rgba(0,0,0,.06);
}
.feature h3 { margin:.25rem 0 .35rem; font-size:1.05rem; color:#0f172a; }
.feature p { color:#4b5563; font-size:.98rem; }
@media (min-width: 768px){ .feature{ grid-column: span 3; } }

.feature-icon{
  width:40px; height:40px; color:#16a34a; margin-bottom:.6rem; flex-shrink:0;
}

/* Stats – light band */
.stats { background:#f5f7f6; }
.stats-grid { display:grid; grid-template-columns: repeat(12, 1fr); gap: var(--gap); align-items:center; }
.stat { grid-column: span 12; text-align:center; padding:1rem 0; }
.num { font-size: clamp(1.6rem, 4vw, 2.2rem); font-weight:800; color:#0f172a; }
.label { color:#4b5563; }
@media (min-width:768px){ .stat{ grid-column: span 4; } }

/* Cards – light */
.cards { display:grid; grid-template-columns: repeat(12, 1fr); gap: var(--gap); }
.card { grid-column: span 12; background:#fff; border-radius:14px; overflow:hidden; box-shadow:0 4px 16px rgba(0,0,0,.06); display:flex; flex-direction:column; padding:1rem; transition: transform 0.2s ease-in-out, box-shadow 0.2s ease-in-out; }
.card img { width:100%; height:180px; object-fit:cover; }
.card-body { padding:1rem; display:flex; gap:.75rem; align-items:center; justify-content:space-between; }
.card-body h3 { font-size:1rem; color:#0f172a; }
.card-body p { color:#6b7280; font-size:.9rem; }
...
/* CTA Strip */
.cta-strip { background:#0e1713; color:#fff; padding: clamp(2.5rem, 4vw, 2rem) 0; height: 10px; display: flex; align-items: center; border-radius: 20px; }
