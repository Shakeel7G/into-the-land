...
const BASE = process.env.VUE_APP_BACKEND_URL || 'https://into-the-land-backend.onrender.com'; // this allows the base URL to be set via an environment variable, defaulting to localhost if not set
